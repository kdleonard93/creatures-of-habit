  ...
  {:else if currentStep === 3}
    <div class="space-y-4">
      ...
      <div>
        ...
        {/if}
		{#if statsWarning}
			<div class="mt-4 p-3 bg-yellow-100 border border-yellow-300 rounded-md text-yellow-800">
      ...
      <div class="mt-4">
        ...
        <div class="flex justify-between items-center mb-2">
          ...
          <span class={remainingStatPoints > 0 ? 'font-bold text-yellow-600' : 'font-bold text-green-600'}>
            {remainingStatPoints}
          </span>
        </div>
